...
\todo{Discuss model reconciliation and model merging. Pascal and Mauro? }
...
\todo{Add metric on the runtime of solving the problem.}
\todo{Discussion: what about a metric on how many real plans can be validated by the learned model.}
\todo{Maybe: add some unsolvability detection metrics?}

\todo{TODO Mauro?: Add a discussion on the limitation of this metric?}
